                        ...
                        <div class="row single-slide align-items-center d-flex">
                            ...
                            <div class="col-lg-7">
                                <div class="banner-img">
                                    <img class="img-fluid" src="{{ asset('assets/img/user/banner/banner-img.png') }}"
                                        alt="">
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-12">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="single-deal">
                                <div class="overlay"></div>
                                <img class="img-fluid w-100" src="{{ asset('assets/img/user/category/c3.jpg') }}"
                                    alt="">
                                <a href="{{ asset('assets/img/user/category/c3.jpg') }}" class="img-pop-up"
                                    target="_blank">
                                    <div class="deal-details">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <div class="single-deal">
                                <div class="overlay"></div>
                                <img class="img-fluid w-100" src="{{ asset('assets/img/user/category/c4.jpg') }}"
                                    alt="">
                                <a href="{{ asset('assets/img/user/category/c4.jpg') }}" class="img-pop-up"
                                    target="_blank">
                                    <div class="deal-details">
                                        <h6 class="deal-title">Sneaker for Sports</h6>
                                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-deal">
                        <div class="overlay"></div>
                        <img class="img-fluid w-100" src="{{ asset('assets/img/user/category/c5.jpg') }}"
                            alt="">
        ...
        <div class="container-fluid">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-6 no-padding exclusive-left">
                    ...
                    <a href="{{ url('/favorit') }}"class="primary-btn">Shop Now</a>
                </div>
        ...
        <div class="container">
            <div class="row">
                <a class="col single-img" href="#">
                    <img class="img-fluid d-block mx-auto" src="{{ asset('assets/img/user/brand/1.png') }}"
                        alt="">
                </a>
                <a class="col single-img" href="#">
                    <img class="img-fluid d-block mx-auto" src="{{ asset('assets/img/user/brand/1.png') }}"
