		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="index.html"><img src="{{ asset('assets/img/user/logo.png') }}" alt=""></a>
						...
						<div class="row single-slide align-items-center d-flex">
							...
							<div class="col-lg-7">
								<div class="banner-img">
									<img class="img-fluid" src="{{ asset('assets/img/user/banner/banner-img.png') }}" alt="">
								</div>
							</div>
						</div>
						<!-- single-slide -->
			...
			<div class="row features-inner">
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single-features">
						<div class="f-icon">
							<img src="{{ asset('assets/img/user/features/f-icon1.png') }}" alt="">
						</div>
						<h6>Free Delivery</h6>
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single-features">
						<div class="f-icon">
							<img src="{{ asset('assets/img/user/features/f-icon2.png') }}" alt="">
						</div>
						<h6>Return Policy</h6>
						<p>Free Shipping on all order</p>
					</div>
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single-features">
						<div class="f-icon">
							<img src="{{ asset('assets/img/user/features/f-icon3.png') }}" alt="">
						</div>
						<h6>24/7 Support</h6>
						<p>Free Shipping on all order</p>
					</div>
		...
		<div class="container">
			<div class="row justify-content-center">
					...
					<div class="row">
						<div class="col-lg-8 col-md-8">
							<div class="single-deal">
								...
								<img class="img-fluid w-100" src="{{ asset('assets/img/user/category/c1.jpg') }}" alt="">
						...
						<div class="col-lg-4 col-md-4">
							<div class="single-deal">
								<div class="overlay"></div>
								<img class="img-fluid w-100" src="{{ asset('assets/img/user/category/c2.jpg') }}" alt="">
						...
						<div class="col-lg-4 col-md-4">
							<div class="single-deal">
								<div class="overlay"></div>
								<img class="img-fluid w-100" src="{{ asset('assets/img/user/category/c3.jpg') }}" alt="">
								<a href="{{ asset('assets/img/user/category/c3.jpg') }}" class="img-pop-up" target="_blank">
									<div class="deal-details">
						...
						<div class="col-lg-8 col-md-8">
							<div class="single-deal">
								<div class="overlay"></div>
								<img class="img-fluid w-100" src="{{ asset('assets/img/user/category/c4.jpg') }}" alt="">
								<a href="{{ asset('assets/img/user/category/c4.jpg') }}" class="img-pop-up" target="_blank">
									<div class="deal-details">
										<h6 class="deal-title">Sneaker for Sports</h6>
									</div>
								</a>
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-deal">
						<div class="overlay"></div>
						<img class="img-fluid w-100" src="{{ asset('assets/img/user/category/c5.jpg') }}" alt="">
						<a href="{{ asset('assets/img/user/category/c5.jpg') }}" class="img-pop-up" target="_blank">
							<div class="deal-details">
								<h6 class="deal-title">Sneaker for Sports</h6>
							</div>
						</a>
		...
		<div class="container">
			<div class="row">
				<a class="col single-img" href="#">
					<img class="img-fluid d-block mx-auto" src="{{ asset('assets/img/user/brand/1.png') }}" alt="">
				</a>
				<a class="col single-img" href="#">
					<img class="img-fluid d-block mx-auto" src="{{ asset('assets/img/user/brand/1.png') }}" alt="">
				</a>
				...
				<div class="col-lg-3">
					<div class="ctg-right">
						<a href="#" target="_blank">
							<img class="img-fluid d-block mx-auto" src="{{ asset('assets/img/user/category/c5.jpg') }}" alt="">
						</a>
					</div>
				</div>
			</div>
