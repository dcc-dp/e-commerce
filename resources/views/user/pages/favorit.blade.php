            ...
            <div class="row">
                @if (!Auth::check())
                    <div class="alert alert-warning text-center">
                        ...
                        Silakan <a href="{{ route('userLogin') }}">login</a> untuk melihat isi
                        keranjang.
                    </div>
                @else
                                ...
                                <div class="product-details">
                                    ...
                                    <div class="prd-bottom">
                                        ...
                                        <form action="{{ route('userTambahFavorit') }}" class="social-info" method="POST">
                                            @csrf
                                            <input type="text" name="produk_id" value="{{ $produkFavorit->produk->id }}"
                                                hidden>
                                        ...
                                        <a href="{{ url('/singleproduct', $produkFavorit->produk->id) }}"
                                            class="social-info">
