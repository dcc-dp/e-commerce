...
@section('title', 'Category - Karma Shop')
            ...
            <div class="col-xl-9 col-lg-8 col-md-7">
                ...
                <section class="lattest-product-area pb-40 category-list">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-product">
                                <img class="img-fluid" src="{{ asset('assets/img/user/product/p4.jpg') }}"
                                    alt="">
                                <div class="product-details">
                                    <h6>addidas New Hammer sole
                                        for Sports person</h6>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-product">
                                <img class="img-fluid" src="{{ asset('assets/img/user/product/p5.jpg') }}"
                                    alt="">
                                <div class="product-details">
                                    <h6>addidas New Hammer sole
                                        for Sports person</h6>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-product">
                                <img class="img-fluid" src="{{ asset('assets/img/user/product/p6.jpg') }}"
                                    alt="">
                                <div class="product-details">
                                    <h6>addidas New Hammer sole
                                        for Sports person</h6>
