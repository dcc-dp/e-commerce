...
<div class="col"><h5>Data Produk</h5></div>
<div class="col d-flex justify-content-end">
  <form class="mx-3">
        ...
        <button type="button" class="btn rounded-pill btn-primary" onclick="window.location.href='{{ route('toko-produk-tambah') }}'">Tambah</button>
